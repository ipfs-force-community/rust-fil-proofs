...
pub struct Settings {
    ...
    pub use_fpga_column_builder: bool,
    pub use_fpga_tree_builder: bool,
    pub fpga_column_max_n: u32,
    pub fpga_tree_max_n: u32,
...
impl Default for Settings {
    fn default() -> Self {
        Settings {
            ...
            use_fpga_column_builder: true,
            fpga_column_max_n: 16384,
            use_fpga_tree_builder: true,
            fpga_tree_max_n: 16384,
